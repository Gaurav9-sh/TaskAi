    ...
    <div className='h-full overflow-y-scroll p-6 flex items-start flex-wrap gap-4 text-slate-700'>
      ...
      <div className='w-full max-w-lg p-4 bg-white rounded-lg flex flex-col border border-gray-200 min-h-96'>
...

            {
              ...
              :
              (
                <div className='flex-1 flex flex-col mt-3 gap-4'>
                  <img src={content} alt="image" className='w-full h-full object-contain rounded-md border border-gray-200' />

                  <a
                    href={content}
                    download="object-removed.png"
                    className='w-full flex justify-center items-center gap-2 bg-gradient-to-r from-[#417DF6] to-[#8E37EB] text-white px-4 py-2 text-sm rounded-lg cursor-pointer transition hover:opacity-90'
                  >
                    Download Image
                  </a>
                </div>
