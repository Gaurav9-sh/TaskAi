              ...
              !content ? (
                ...
                <div className='flex-1 flex flex-col mt-3 gap-4'>
                  ...
                  <a
                    ...
                    className='w-full flex justify-center items-center gap-2 bg-gradient-to-r from-[#00AD25] to-[#04FF50] text-white px-4 py-2 text-sm rounded-lg cursor-pointer transition hover:opacity-90'
                  >
                    Download Image
                  </a>
                </div>
