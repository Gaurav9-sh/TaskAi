              ...
              (
                ...
                <img src={content} alt="image" className='w-full h-full object-contain rounded-md border border-gray-200' />              
                    <a
                      href={content}
                      download
                      className='w-full flex justify-center items-center gap-2 bg-gradient-to-r from-[#F6AB41] to-[#FF4938] text-white px-4 py-2 text-sm rounded-lg cursor-pointer transition hover:opacity-90'
                    >
                      Download Image
                    </a>
              </div>
